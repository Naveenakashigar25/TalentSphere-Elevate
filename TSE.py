...
st.set_page_config(
    page_title="Talent Management Platform for Employee Performance and Career Growth",
    page_icon="🧑‍💼",
    layout="wide",
)
...
st.markdown(
    ...
    <div class="tse-banner">
        <div class="tse-title">Talent Management Platform For Employee Performance and Career Growth</div>
...
if st.session_state.page == "Home":
    ...
    with home_col1:
        ...
        st.header("Welcome to Talent Mangement Platform For Employee Performance and Career Growth")

        st.write("""
Talent Mangement Platform For Employee Performance and Career Growth is an AI-powered career guidance platform designed for:

- Professionals

It helps users explore careers, improve skills and receive career guidance.
""")
...
# -------------------------------
    ...
    st.header("About Talent Mangement Platform For Employee Performance and Career Growth")

    st.subheader("Objectives")

    objectives = [
        ("To develop a centralized Platform"),
        ("To assess employee performance and skills"),
        ("To provide personalized career-growth recommendations")
